<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <!-- Back Button -->
            <div class="mb-6">
                <a href="{{ request('back', route('challenges.show', $challenge)) }}" class="inline-flex items-center space-x-2 text-gray-600 hover:text-gray-800 transition-colors duration-200">
                ...
                <div class="p-8">
                    <form action="{{ route('challenges.update', $challenge) }}" method="POST" id="challenge-form">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $challenge->name) }}" 
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="3" 
                                      ...
                                      placeholder="Describe what this challenge is about...">{{ old('description', $challenge->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600 flex items-center space-x-1">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        ...
                        <div class="mb-8">
                            <label class="block text-sm font-bold text-gray-800 mb-4 flex items-center space-x-2">
                            ...
                            <div class="bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200 rounded-xl p-6">
                                <div id="existing-goals" class="space-y-4">
                                    @foreach($challenge->goals as $index => $goal)
                                        <div class="existing-goal-item bg-white rounded-lg p-4 border border-gray-200">
                        ...
                        <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                            <button type="submit" class="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-3 px-8 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 flex items-center space-x-2">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
