                    ...
                    @elseif(!$challenge->completed_at)
                        ...
                        @if($challenge->is_active)
                            ...
                            <form method="POST" action="{{ route('challenges.pause', $challenge) }}">
                                @csrf
                                <button type="submit" class="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white font-bold py-2 px-4 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 flex items-center space-x-2">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
