<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Create New Habit" gradient="success">
            <x-slot name="icon">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex space-x-3 mb-4">
                            <button type="button" 
                                    ...
                                    :class="useExisting ? 'bg-blue-500 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'"
