        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="card">
                    ...
                    <div class="text-3xl font-bold text-blue-600 dark:text-blue-400">{{ $stats['active_challenges'] }}</div>
                </div>

                <div class="card">
                    <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">Active Habits</div>
                    <div class="text-3xl font-bold text-teal-600 dark:text-teal-400">{{ $stats['active_habits'] }}</div>
                </div>
            </div>
                ...
                <div class="card card-no-padding mb-4">
                    <nav class="flex -mb-px">
                        <button @click="activeTab = 'challenges'" 
                                :class="activeTab === 'challenges' ? 'border-blue-500 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-100 hover:border-gray-300 dark:hover:border-gray-600'"
                                class="w-1/2 py-4 px-1 text-center border-b-2 font-medium text-sm transition-colors duration-150">
                            Challenges
                            <span class="ml-2 px-2 py-1 text-xs rounded-full" :class="activeTab === 'challenges' ? 'bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400'">
                                {{ $challenges->count() }}
                            </span>
                        </button>
                        <button @click="activeTab = 'habits'" 
                                :class="activeTab === 'habits' ? 'border-teal-500 text-teal-600 dark:text-teal-400' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-100 hover:border-gray-300 dark:hover:border-gray-600'"
                                class="w-1/2 py-4 px-1 text-center border-b-2 font-medium text-sm transition-colors duration-150">
                            Habits
                            <span class="ml-2 px-2 py-1 text-xs rounded-full" :class="activeTab === 'habits' ? 'bg-teal-100 dark:bg-teal-900 text-teal-600 dark:text-teal-400' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400'">
                                {{ $habits->count() }}
                            </span>
                        </button>
                    </nav>
