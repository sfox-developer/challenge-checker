                ...
                <div class="card card-no-padding mb-4">
                    <nav class="flex -mb-px">
                        <button @click="activeTab = 'challenges'" 
                            ...
                            Challenges
                            <span class="ml-2 px-2 py-1 text-xs rounded-full" :class="activeTab === 'challenges' ? 'bg-blue-100 dark:bg-blue-900 text-slate-700 dark:text-slate-400' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400'">
                                {{ $challenges->count() }}
                            </span>
                        </button>
                        <button @click="activeTab = 'habits'" 
                                ...
                                class="w-1/2 py-4 px-1 text-center border-b-2 font-medium text-sm transition-colors duration-150">
                            Habits
                            <span class="ml-2 px-2 py-1 text-xs rounded-full" :class="activeTab === 'habits' ? 'bg-blue-100 dark:bg-blue-900 text-slate-700 dark:text-slate-400' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400'">
                                {{ $habits->count() }}
                            </span>
                        </button>
                    </nav>
