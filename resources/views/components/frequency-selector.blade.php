...
<div class="mb-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <label class="cursor-pointer">
            ...
            <div class="p-4 text-center rounded-lg border-2 border-gray-300 dark:border-gray-600 peer-checked:border-blue-500 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-500/10 transition-all duration-200">
...
<div class="mb-6" x-show="frequencyType !== 'daily'">
    ...
    <div class="grid grid-cols-7 gap-2">
        <template x-for="i in 7" :key="i">
            <label class="cursor-pointer">
                ...
                <div class="aspect-square flex items-center justify-center rounded-lg border-2 border-gray-300 dark:border-gray-600 peer-checked:border-blue-500 peer-checked:bg-blue-500 peer-checked:text-white font-bold text-lg text-gray-900 dark:text-gray-100 transition-all duration-200" x-text="i"></div>
            </label>
        </template>
    </div>
    ...
    <div class="mt-3">
        <p class="text-sm text-gray-600 dark:text-gray-400 text-center" x-show="frequencyCount > 0">
            <span class="font-semibold text-blue-600 dark:text-blue-400" x-text="frequencyCount"></span>
