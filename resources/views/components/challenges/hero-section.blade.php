    ...
    <div class="container max-w-4xl">
        <div class="text-center animate animate-hidden-fade-up-sm"
            ...
            <h2 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-2">
                Transform goals into <span class="lottie-underline">achievements<span class="lottie-underline-animation" x-lottie="{ path: '/animations/line.json', loop: false, autoplay: false, stretch: true, scrollProgress: true }"></span></span>
            </h2>
