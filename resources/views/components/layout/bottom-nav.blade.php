...
<nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50 sm:hidden">
    <div class="grid grid-cols-5 h-16">
        <!-- Feed -->
        <a href="{{ route('feed.index') }}" class="flex flex-col items-center justify-center space-y-1 {{ request()->routeIs('feed.*') ? 'text-slate-700' : 'text-gray-600' }} hover:text-slate-700 transition-colors duration-200">
        ...
        <!-- Challenges -->
        <a href="{{ route('challenges.index') }}" class="flex flex-col items-center justify-center space-y-1 {{ request()->routeIs('challenges.*') && !request()->routeIs('challenges.show') ? 'text-slate-700' : 'text-gray-600' }} hover:text-slate-700 transition-colors duration-200">
        ...
        <!-- Habits -->
        <a href="{{ route('habits.index') }}" class="flex flex-col items-center justify-center space-y-1 {{ request()->routeIs('habits.*') ? 'text-slate-700' : 'text-gray-600' }} hover:text-slate-700 transition-colors duration-200">
        ...
        <!-- Active (Dashboard) -->
        <a href="{{ route('dashboard') }}" class="flex flex-col items-center justify-center space-y-1 {{ request()->routeIs('dashboard') ? 'text-slate-700' : 'text-gray-600' }} hover:text-slate-700 transition-colors duration-200">
        ...
        <!-- Profile -->
        <a href="{{ route('profile.edit') }}" class="flex flex-col items-center justify-center space-y-1 {{ request()->routeIs('profile.*') ? 'text-slate-700' : 'text-gray-600' }} hover:text-slate-700 transition-colors duration-200">
