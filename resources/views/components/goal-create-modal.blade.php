{{--
    Shared Goal Create Modal
    
    Props:
    - categories: Array of goal categories
...
<template x-teleport="body">
    ...
    <div @click.stop
        ...
        <div class="modal-header">
            ...
            <p class="modal-description">Add a new goal to your library</p>
        </div>
            ...
            <form @submit.prevent="saveNewGoal()">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                           ...
                           @keydown.enter="newGoal.name.trim() && saveNewGoal()"
                           class="form-input" 
