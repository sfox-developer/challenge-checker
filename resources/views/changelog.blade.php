<x-public-layout>
    ...
    <div class="static-page-container">
        <div class="static-page-header">
            ...
            <div>
                <h1 class="static-page-title">Changelog</h1>
                <p class="static-page-subtitle">Latest updates and new features</p>
            </div>
        </div>
        ...
        <div class="space-y-6">
            @forelse($changelogs as $changelog)
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-200">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center space-x-3 mb-2">
                                ...
                                @if($changelog->is_major)
                                    <span class="px-3 py-1 text-xs font-medium bg-slate-700 dark:bg-slate-600 text-white rounded-full">
                                        🚀 Major Release
                                    </span>
                                @endif
                            </div>
                    ...
                    <div class="space-y-2 text-gray-700 dark:text-gray-300 leading-relaxed">
