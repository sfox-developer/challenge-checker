<x-app-layout>
    <x-slot name="header">
        <x-page-header :title="$query ? 'Search Users' : 'Discover Users'">
            <x-slot name="icon">
                    ...
                    @empty
                        <div class="card">
                            <div class="p-12 text-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-800 dark:text-gray-100 mb-2">No users found</h3>
                                <p class="text-gray-600 dark:text-gray-400">Try searching with a different term.</p>
                            </div>
                        </div>
                    @endforelse
                </div>
            @else
                <div class="card">
                    <div class="p-12 text-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-800 dark:text-gray-100 mb-2">Start searching</h3>
                        <p class="text-gray-600 dark:text-gray-400">Enter a name or email to find other users.</p>
                    </div>
                </div>
            @endif
        </div>
