                        ...
                        <div class="card card-hover">
                            <!-- Challenge Header -->
                                <div class="flex items-start justify-between mb-4">
                                    <div class="flex-1">
                                        <h4 class="text-lg font-semibold text-gray-800 dark:text-gray-100 dark:text-gray-100 mb-2">{{ $challenge->name }}</h4>
                                ...
                                <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-gray-100">
                                    ...
                                    @else
                                        <span class="px-2 py-1 bg-gray-100 text-gray-800 dark:text-gray-100 text-xs font-semibold rounded-full">Not Started</span>
                                    @endif
                                </div>
                            </div>
                        </div>
