<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Privacy Policy" gradient="from-blue-500 to-indigo-500">
            <x-slot name="icon">
            ...
            <div class="card">
                ...
                <div class="prose dark:prose-invert max-w-none prose-headings:text-gray-900 dark:prose-headings:text-gray-100 prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-li:text-gray-700 dark:prose-li:text-gray-300 prose-strong:text-gray-900 dark:prose-strong:text-gray-100">
                    <h2 class="flex items-center text-xl font-semibold mt-8 mb-4">
                        <span class="w-2 h-8 bg-gradient-to-b from-blue-500 to-indigo-500 rounded mr-3"></span>
                        Introduction
                    </h2>
                    <p>
                    ...
                    <h3 class="text-lg font-semibold mt-6 mb-3 text-blue-600 dark:text-blue-400">Personal Information</h3>
                    ...
                    <h3 class="text-lg font-semibold mt-6 mb-3 text-blue-600 dark:text-blue-400">Automatically Collected Information</h3>
