...
class GoalLibraryController extends Controller
{
     ...
     */
    private function getConsistencyScore(GoalLibrary $goal): array
    {
        $completions = $goal->completions()
            ->whereNotNull('completed_at')
            ->orderBy('date')
     ...
     */
    private function getTimePatterns(GoalLibrary $goal): array
    {
        $completions = $goal->completions()
            ->whereNotNull('completed_at')
            ->get();
     ...
     */
    private function getMilestones(GoalLibrary $goal): array
    {
     ...
     */
    private function getMonthlyTrendData(GoalLibrary $goal): array
    {
        $labels = [];
        $data = [];
     ...
     */
    private function getMilestoneProgressData(GoalLibrary $goal): array
    {
        $totalCompletions = $goal->completions()->whereNotNull('completed_at')->count();
